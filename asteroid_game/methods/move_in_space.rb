...
def move_in_space (small_circle, big_circle, degree, new_x_position, new_y_position)
    small_circle.x = Math.cos(degree_to_radian(degree)) * (small_circle.radius + big_circle.radius) + big_circle.x + new_x_position
    small_circle.y = Math.sin(degree_to_radian(degree)) * (small_circle.radius + big_circle.radius) + big_circle.y + new_y_position
end